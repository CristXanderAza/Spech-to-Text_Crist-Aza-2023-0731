...
- Create Angular project with ng: `ng new spech-to-text_crist-aza-2023-0731.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`spech-to-text_crist-aza-2023-0731.client.esproj`).
